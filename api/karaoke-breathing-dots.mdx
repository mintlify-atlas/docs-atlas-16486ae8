---
title: "KaraokeBreathingDots Composable API Reference"
sidebarTitle: "KaraokeBreathingDots"
description: "API reference for KaraokeBreathingDots — renders animated pulsing dots during instrumental intros and interludes, with configurable timing and appearance."
---
...
|---|---|---|
| **1 — Enter** | `currentTime < enterEnd` | Alpha and scale ramp from `0` → `1` using `FastOutSlowInEasing` over `enterDurationMs`. Dots fade in and grow into view. |
